...
The only exceptions to this are in week 1 and 14, during which we mix things up a bit.
...
1. To take the **assessments** that occur during the course, and the final examination.
2. To recieve **important messages** about the course.
...
Please bring your laptop to class. Please make sure that it has sufficient battery charge to last the duration of the class, as there are few power sockets in **Y24-G-45**. Please make sure you know how to use it (some people are sometimes not so sure, perhaps because its new, or they borrow someone else's.) Your laptop must be able to connect to the wireless internet at UZH, and you will need two software programmes.

We will be using three computer programmes during class, please make sure you have them:
...
1. Each week there will be questions about the class on OpenEdX\@UZH. You must answer 60% of these questions correctly in order to be permitted to sit the final examination.
2. A final assessment during the module examination period in July. Exact date and location to be confirmed.
