...
There are several teaching assistants for the course, most of which are current PhD students. You will get to know them during the course.
...
You will use [OpenEdX\@UZH](https://openedx.mnf.uzh.ch/courses/course-v1:UZH+BIO144+FS2017/about):

* To view **video lectures** and take quick, **instant feedback quizzes**.
* To take the **assessments** that occur during the course, and the final examination.
* To recieve **important messages** about the course.
* For **discussing and communicating** all and anything about the course.


## Enrolling on the OpenEdX course {-}

You must yourself enrol in the course in OpenEdX\@UZH. To do this you must create an account on OpenEdX\@UZH, if you haven't already.

1. **Important**: Please use your UZH email address when you create your OpenEdX\@UZH account.
2. Create your OpenEdX\@UZH on [this web page](https://openedx.mnf.uzh.ch/register).
3. You can then log in with the "Sign in with the University of Zurich" button, and on [your settings page](https://openedx.mnf.uzh.ch/account/settings) link your OpenEdX\@UZH account with your UZH Switch account.


## Verify your UZH identity on OpenEdX\@UZH {-}

As we will be using OpenEdX\@UZH for assessments, including the final examination, we need to verify your identity on OpenEdX\@UZH. To do this, please go to the Courseware and the "IMPORTANT! DO THIS NOW!" module, and follow the instructions there.
...
## What must I do before each class? {-}


You must complete the assigned required reading / viewing. This material is essential and will not be covered during class (lecture or practical). If you do not complete the assigned reading you will have great trouble with the practical exercises, and with answering the weekly practical related questions correctly. Answering 60% or more of these questions correctly is required to be permitted to sit the final exam.
...
1. Each week there will be questions about the class on OpenedX. You must answer 60% of these questions correctly in order to be permitted to sit the final assessment. The aims of these regular assessments are:
...
2. A final assessment during the module examination period. Date and time are June 13th, 14-16.00. Location to be confirmed. *Important* -- this is an "open book" exam, and will be delivered on OpenEdX\@UZH. You will, therefore, need to take your laptop into the exam, and make sure you have enough battery power to last the exam. You can take anything else you like into the exam also. You may consult any information source, apart from one type: you are not permitted to communicate in any way with any other person during the exam. The exam will be carefully invigilated / policed to monitor against this.
