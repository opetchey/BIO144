...
\date[]{Lecture 10: Modeling binary data  \\ 17./18. May 2018}
...
{\bf  Specifically: } Do high concentrations of the plasma proteins Fibrinogen and Globulin (which are disease indicators) incrase the probability that ESR$>20mm/hr$?\\[6mm]

{\bf The model to be fitted:}\\

\begin{equation*}
\log\left( \frac{\pi_i}{1-\pi_i} \right) = \beta_0 + \beta_1 fibrinogen_i + \beta_2 globulin_i \ ,
\end{equation*}
\\[4mm]
