...
\end{Sinput}
\end{Schunk}
\includegraphics{Bio144_2017_practical6_solution-013}
...
\end{Sinput}
\end{Schunk}
\includegraphics{Bio144_2017_practical6_solution-014}
\begin{Schunk}
\begin{Sinput}
> ggplot(r.coef,aes(x=beta0,y=beta2)) + geom_point()
\end{Sinput}
\end{Schunk}
\includegraphics{Bio144_2017_practical6_solution-015}
\begin{Schunk}
\begin{Sinput}
