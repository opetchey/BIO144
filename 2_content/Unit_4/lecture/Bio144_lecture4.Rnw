...
<<fig4, eval=T,fig.width=4, fig.height=4.5,warning=FALSE,echo=F,out.width="4cm">>=
...
\vspace{2mm}
Please see also IC: practical 4 (todo: check) for an example and more thoughts.
...
\begin{center}
<<fig6, eval=T,fig.width=5, fig.height=5,warning=FALSE,echo=F,out.width="8cm">>=
...
<<wurmP2, eval=T,fig.width=5, fig.height=3.5,warning=FALSE,echo=F,out.width="5.5cm">>=
library(ggplot2)
...
\begin{center}
<<wurmP3, eval=T,fig.width=6, fig.height=4.2,warning=FALSE,echo=F,out.width="8cm">>=
