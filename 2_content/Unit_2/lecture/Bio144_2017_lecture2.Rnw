...
{\small (Question: do you remember why this is a t-distribution? Check Mat183, keyword: t-test.)}
...
\item {\bf If necessary} (if things are not clear on the slides), consult the "Course material covered today" (see slide 3).\\[2mm]
