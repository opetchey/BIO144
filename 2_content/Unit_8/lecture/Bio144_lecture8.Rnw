...
\date[]{Lecture 8: Interpretation, causality, cautionary notes \\ 26./27. April 2018}
...
\begin{itemize}
\item Literature and articles that you will have to read in the second self-study week (second week of May).
\end{itemize}
...
\item Recent articles in \emph{Science}, \emph{Nature} or a statement by the \emph{American Statistical Associaton (ASA)} in March 2016 show that the debate still continues \citep{goodman2016,wasserstein.lazar2016}.\\[2mm]
...
\frame{\frametitle{}
The most recent suggestion by 72 authors in the field:\\[4mm]
...
Body fat example, slide 39 of lecture 2. \\[3mm]
...
\begin{tabular}{lll}
 ...
 {\bf Analysis} & Difficult & Simple    \\
   & (see model selection issues) & \alert{no model selection}   \\[3mm]
