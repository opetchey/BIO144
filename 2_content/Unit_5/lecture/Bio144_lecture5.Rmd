...
Typically: the alpabetically first category is the reference, thus $\beta_1=0$.
...
\textbf{Problem:} The $p$-values of the t-test for each of the worm species are not very
...
```{r eval=T,echo=FALSE,message=FALSE,warning=FALSE,out.width="4cm",fig.align='center', fig.width=4, fig.height=4}
