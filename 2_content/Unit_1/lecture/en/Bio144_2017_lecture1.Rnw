...
Lecture times always :00 bis :45\\
\begin{center}$\rightarrow$ Last lesson: {\bf from 16:00 to 16:45}.\end{center}
}
...
{\bf Week 7} Model selection  \\[1mm]
{\bf Self-study week} \\[4mm]
...
\item {\bf Communicate results} precisely and carefully (publication, articles..)
\end{enumerate}
