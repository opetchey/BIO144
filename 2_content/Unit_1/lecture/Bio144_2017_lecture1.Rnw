...
\frame{\frametitle{Kurs-Fahrplan (14 Wochen, 12 Vorlesungen)}
\vspace{-8mm}

\begin{multicols}{2}
1. L1 Einf\"uhrung und Ausblick \\[1mm]
2. L2 Einfache lineare Regression\\[1mm]
3. L3 Residuenanalyse, Modellvalidierung \\[1mm]
4. L4 Multiple lineare Regression \\[1mm]
5. L5 ANOVA  \\[1mm]
6. L6 ANCOVA, Matrix Algebra \\[1mm]
7. L7 Modellwahl  \\[1mm]
8. Selbststudium  \\[1mm]
9. L8 Interpretation von Resultaten, Kausalit\"at \\[1mm]
10. L9 Z\"ahldaten (Poisson Regression) \\[1mm]
11. L10 Bin\"are Daten (logistische Regression)\\[1mm]
12. L11 Messfehler, zuf\"allige Effekte \\[1mm]
13. Selbststudium  \\[1mm]
14. L12 Ausgew\"ahlte Themen, Wiederholungen und Ausblick \\
\end{multicols}
~\\
...
<<hg2,fig=T,height=2.2,width=5.5,echo=F>>=
...
plot(log(Hg_urin) ~ log(Hg_soil), data=d.hg, xlab="Hg Boden",
     ylab = "Hg Urin",pch=21,bg=as.numeric(mother)+2,xlim=c(-4.5,4.5),cex=1.2)
