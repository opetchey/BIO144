...
Studie mit 241 M\"annern, von welchen das K\"orperfett (in \%) und andere Variablen wie Alter, Gewicht, K\"orpergr\"osse, BMI, Nackenfett und Bauchumfang gemessen wurden.\\[4mm]
...
plot((Hg_urin) ~ amalgam_quant, data=d.hg, xlab="Amalgamfuellungen", ylab = "Hg Urin")
plot((Hg_urin) ~ age, data=d.hg, xlab="Alter", ylab = "")
plot((Hg_urin) ~ Meerfisch_quant, data=d.hg, xlab="Meerfischkonsum/Monat", ylab = "")
@ 
\end{center}
\vspace{5mm}
