...
\frame{\frametitle{Are the modellign assumptions met?}
...
\frame[containsverbatim]{\frametitle{Model checking tools I: Tukey-Anscombe diagram}

The \myalert{Tukey-Anscombe} diagram plots the residuals against the fitted values:
\begin{center}
\setkeys{Gin}{width=0.5\textwidth}
\includegraphics{Bio144_2017_week2-TA}
\end{center}
This plot is ideal to check if assumptions a) and b) (and partially d)) are met. Here, this seems fine.
}


\frame[containsverbatim]{\frametitle{Model checking tools II: Histogram}
 
Look at the histogram of the residuals:
\begin{center}
\setkeys{Gin}{width=0.5\textwidth}
\includegraphics{Bio144_2017_week2-hist}
\end{center}
The normal distribution assumptions seems ok as well.
...
\end{Sinput}
\end{Schunk}
\includegraphics{Bio144_2017_week2-012}
