...
<<echo=F,eval=T>>=
d.wurm <- read.table ("/home/steffi/Teaching/Bio144/data_examples/ancova/Projekt6Regenwuermer/RegenwuermerDaten_Haupt.txt",header=T)
...
<<echo=F>>=
d.chol <- read.table ("/home/steffi/Teaching/Bio144/data_examples/ancova/cholesterol/cholesterol.txt",header=T)
@
\begin{center}
\setkeys{Gin}{width=0.60\textwidth}
<<chol,fig=T,width=4.5,height=3.6,eval=T>>=
