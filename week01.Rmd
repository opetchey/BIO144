...
1. Review relevant material from previous courses. You've learnt a lot of relevant things in previous courses, particularly during MAT183 - Stochastik für die Naturwissenschaften. You must review that previous learning, by following the information on the ([Expected competencies] page).

2. Learn about Getting help with R. Go to the course content on OpenEdx\@UZH and work through the section in Week 1 called [Getting help about R and RStudio](https://openedx.mnf.uzh.ch/courses/course-v1:UZH+BIO144+FS2017/courseware/cc6c2e81a50549b19d74c7dabdc892e7/f214da52a96a464ea6692fcd6bed9209/).

3. Learn about R Add-on packages. Go to the course content on OpenEdx\@UZH and work through the section in Week 1 [Add-on packages](https://openedx.mnf.uzh.ch/courses/course-v1:UZH+BIO144+FS2017/courseware/cc6c2e81a50549b19d74c7dabdc892e7/e7cafbc0919445edb81bc6cf6ce89a31/). 
...
### 1.00 - 2.30pm (approx.) -- Getting started  {-}

* Introductions.
* Walkthrough course details ([About the course]).
* Introductory lecture. [PDF of the lecture by Dr. Muff.](https://github.com/opetchey/BIO144/raw/master/lectures/week1/Bio144_2017_week1.pdf)
...
### 2.30 - 3.30pm (approx.) -- Live data analysis demonstration {-}

We will attempt to go through the entire workflow during the class! This will be a good opportunity to recap some of the things you should already know, and to show some of the things you will learn. Overall, it will show you the workflow and approach to data analysis that you'll learn and use during the course.


### 3.30 - 5.00pm (approx.) -- Your turn {-}

* You recreate the data analysis demonstrated in the previous section.
* During this time, we can troubleshoot any issues you're having.
* Complete the Week 1 graded assessment on OpenEdX\@UZH.
